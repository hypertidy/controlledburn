test_that("adjacent rectangles: vertical shared edge", {
  ...
  r <- burn(polys, extent = c(0,10,0,10), dimension = c(20L,20L))
  expect_complementary(r, label = "vert on-grid")

  # Boundary between grid lines
  r2 <- burn(polys, extent = c(0,10,0,10), dimension = c(12L,12L))
...
test_that("adjacent rectangles: horizontal shared edge", {
  ...
  r <- burn(polys, extent = c(0,10,0,10), dimension = c(15L,15L))
...
test_that("four quadrants", {
  ...
  r <- burn(polys, extent = c(0,10,0,10), dimension = c(16L,16L))
...
test_that("diagonal shared edge", {
  ...
  r2 <- burn(polys, extent = c(0,10,0,10), dimension = c(100L,100L))
