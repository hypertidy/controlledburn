...
The output of `burn_polygon()` is a list of triplet indexes `start,end,row` - these are zero-based atm because they reflect the underlying C++ code. Examples recorder  flatten this to a 3-column matrix (and add 1). 
